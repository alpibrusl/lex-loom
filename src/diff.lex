...
fn diff(old :: graph.SprintGraph, new :: graph.SprintGraph) -> GraphDiff
  examples {
    diff({ id: "g", phase: graph.Intake, nodes: [{ id: "a", role: "build", gate: "spec true", expand: None, activate_when: "" }], edges: [] }, { id: "g", phase: graph.Intake, nodes: [{ id: "a", role: "build", gate: "spec true", expand: None, activate_when: "" }], edges: [] }) => { node_diffs: [], edge_diffs: [] }
  }
{
