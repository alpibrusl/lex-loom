...
fn hello() -> [io] Unit {
  ...
  let sprint_graph := { id: "hello-sprint", phase: graph.Design, nodes: [{ id: "architect", role: "architect", gate: "spec non-empty" }, { id: "build", role: "build", gate: "spec non-empty" }, { id: "qa", role: "qa", gate: "spec non-empty" }, { id: "demo", role: "demo", gate: "spec non-empty" }], edges: [{ from: "architect", to: "build", handoff: "schema {}" }, { from: "build", to: "qa", handoff: "schema {}" }, { from: "qa", to: "demo", handoff: "schema {}" }] }
  ...
  let bad_graph := { id: "bad", phase: graph.Intake, nodes: [{ id: "demo", role: "demo", gate: "spec non-empty" }], edges: [] }
  ...
  let graph_v2 := { id: "hello-sprint", phase: graph.Design, nodes: [{ id: "architect", role: "architect", gate: "spec non-empty" }, { id: "build", role: "build", gate: "spec output != ''" }, { id: "qa", role: "qa", gate: "spec non-empty" }, { id: "demo", role: "demo", gate: "spec non-empty" }, { id: "review", role: "review", gate: "spec non-empty" }], edges: [{ from: "architect", to: "build", handoff: "schema {}" }, { from: "build", to: "review", handoff: "schema {}" }, { from: "review", to: "qa", handoff: "schema {}" }, { from: "qa", to: "demo", handoff: "schema {}" }] }
