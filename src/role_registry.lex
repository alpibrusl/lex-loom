...
fn pack_registry() -> List[(Str, List[Str])] {
  [("core", ["pm", "architect", "build", "py_build", "ts_build", "qa", "py_qa", "ts_qa", "test_author", "py_test_author", "ts_test_author", "devops", "docs", "demo", "scribe", "launch", "deploy"]), ("web", ["fe_build", "ux_designer"]), ("content", ["brand_designer", "content_designer", "brand_strategist", "copywriter", "content_creator", "seo_specialist"]), ("finance", ["finance", "monetization_handoff"]), ("governance", ["legal", "cx"]), ("research", ["research", "opportunity_research"]), ("security", ["security"])]
}
