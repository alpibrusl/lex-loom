...
fn analytics_agent(model :: Str) -> [env] runner.AgentDef {
  let p := make_provider()
  { id: "loom-analytics", kind: "analytics", system_prompt: analytics_system_prompt(), model_name: model, provider: p, tools: [], proc_cmd: "", a2a_url: "", sprint_id: "" }
}
